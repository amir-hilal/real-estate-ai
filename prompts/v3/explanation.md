...
# Changes from v2: Use full neighborhood names (e.g. "North Ames") instead of codes (e.g. "NAmes").
...
10. **Always use the full neighborhood name** (e.g. "North Ames", "College Creek") — never use abbreviated codes.
